...
def install_buildbuddy_dependencies(workspace_name = "buildbuddy"):
    ...
    go_repository(
        ...
        sum = "h1:/y+40JUq18kTNiA6col6DMAqZkoXSTflPCI6YDDyqw4=",
        version = "v0.22.1-0.20220414210452-d678255a6ff8",
    )
    go_repository(
    ...
    # Generated with ./tools/vendor.sh googleapis/go-type-adapters cdaad719a6599c9ef7f83139dbdef1163f397b74 github.com/googleapis/go-type-adapters com_github_googleapis_go_type_adapters
    http_archive(
        name = "com_github_googleapis_go_type_adapters",
        sha256 = "030b4b24249bcd7c8fd36cce45c640c7a7dffd3346a47e451d5edb9ffbbe5fe2",
        strip_prefix = "go-type-adapters-cdaad719a6599c9ef7f83139dbdef1163f397b74",
        urls = ["https://github.com/googleapis/go-type-adapters/archive/cdaad719a6599c9ef7f83139dbdef1163f397b74.zip"],
        patches = ["@%s//buildpatches:com_github_googleapis_go_type_adapters" % workspace_name],
        patch_args = ["-s", "-p0"],
    )
    go_repository(
        ...
        sum = "h1:zTNgRt1iFwVgO9IhNOzOwO28Xj4SSLy4wJvlIp7c4GI=",
        version = "v1.30.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:s1gzb/fg3HhkSLKyWVUsZcVBUo+R1TwEYTmmxH8gGFg=",
        version = "v1.2.5",
    )
    ...
    go_repository(
        ...
        sum = "h1:gntDP+ffGhs7aJ0u8JvjCDts2OsxsI7bnz3q+jC+hSY=",
        version = "v1.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CcBhxqkxPATj7Lgdp9EgPUGv2o3FGkg3A5eN7ermsbM=",
        version = "v1.2.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:DnjEnBXdlUJPo8ShfNPasu7m52iI1ETiST5RvS6b0c4=",
        version = "v0.8.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:UOVMyH2EKkxIfzrULvA9n/tO+HtEhqD9mrLSWMr5FwU=",
        version = "v0.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ivAoWcY5DMs9n04Abc1VkqZBO0FL0h4ShTcVsC53lCE=",
        version = "v2.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WbN9e/jD8ujU+o0vd9IFN5AEwtfB0rn/zM/AANaClqQ=",
        version = "v0.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:h61+hQraWhdI6WYqMwAwZYCE5yxL6a9/Orw4REbabSU=",
        version = "v0.4.8",
    )
    go_repository(
    ...
    go_repository(
        ...
        build_directives = [
            ...
            "gazelle:resolve go github.com/googleapis/go-type-adapters/adapters @com_github_googleapis_go_type_adapters//adapters:adapters",
            "gazelle:resolve go google.golang.org/genproto/googleapis/storage/v2 @org_golang_google_genproto//googleapis/storage/v2:storage",
        ],
    ...
    go_repository(
        ...
        sum = "h1:li8u9OSMvLau7rMs8bmiL82OazG6MAkwPz2i6eS8TBQ=",
        version = "v0.31.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:6r1YrcTenBvYa1x491d0GGpTVBsNECmrc/K6b+zDeis=",
        version = "v1.6.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:f8c93l5tboBYZna1nWk0W9DYyMzJXDWdZcJZ0Kb400U=",
        version = "v1.6.1",
    )
    go_repository(
    ...
    # Generated with ./tools/vendor.sh googleapis/go-genproto 9d709892a2bfffc9d751a59411eb30e134259fd5 google.golang.org/genproto org_golang_google_genproto
    http_archive(
        name = "org_golang_google_genproto",
        sha256 = "0c5a2855ffc13e7ae5665fce8d192afceb42dfc6340dacde483375bffcd11d3a",
        strip_prefix = "go-genproto-9d709892a2bfffc9d751a59411eb30e134259fd5",
        urls = ["https://github.com/googleapis/go-genproto/archive/9d709892a2bfffc9d751a59411eb30e134259fd5.zip"],
        patches = ["@%s//buildpatches:org_golang_google_genproto" % workspace_name],
        patch_args = ["-s", "-p0"],
    )
    ...
    go_repository(
        ...
        sum = "h1:PVGECzEo9Y3uOidtkHGdd347NjLtITfJFO9BxFpmRoo=",
        version = "v0.0.0-20220403205710-6acee93ad0eb",
    )
    go_repository(
